...
function Profile() {
  ...
  return (
    <div className='mb-12'>
      ...
      <div>
        <h1 className='mx-24 mt-12 text-3xl tracking-wider font-thin font-sans'>{profileInfo?.user.toUpperCase()}'s BLOGS</h1>

        <div className='mt-12 mb mx-24 grid grid-cols-3 gap-y-24 items-center gap-x-12'>
